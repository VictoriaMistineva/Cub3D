...
// 			* (all->param_map->dirY * spriteX - all->param_map->dirX * spriteY);
//         double transformY = invDet 
// 			* (-all->param_map->planeY * spriteX + all->param_map->planeX * spriteY); //this is actually the depth inside the screen, that what Z is in 3D
