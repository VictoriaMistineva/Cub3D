...
// 	int i;
// 	i = 0;
// 	// all->sprite->spriteX = all->sprite->sp[all->sprite->sp_order[i]].x - all->param_map->posX;
// 	all->sprite->spriteX = all->sprite->sp->x - all->param_map->posX;
// 	// all->sprite->spriteY = all->sprite->sp[all->sprite->sp_order[i]].y - all->param_map->posY;
// 	all->sprite->spriteY = all->sprite->sp->y - all->param_map->posY;
